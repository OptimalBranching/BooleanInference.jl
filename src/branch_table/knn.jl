function _k_neighboring(tn::ConstraintNetwork, doms::Vector{DomainMask}, focus_var::Int; max_tensors::Int, k::Int = 2)
...
function k_neighboring(tn::ConstraintNetwork, doms::Vector{DomainMask}, focus_var::Int; max_tensors::Int, k::Int = 2)
    return _k_neighboring(tn, doms, focus_var; max_tensors = max_tensors, k = k)
end