...
SolveResult(status, solution, time, branches, solver::String) = SolveResult(status, solution, time, branches, 0, 0.0, 0, 0, solver)
SolveResult(status, solution, time, branches, gamma_one::Int, solver::String) = SolveResult(status, solution, time, branches, gamma_one, 0.0, 0, 0, solver)
SolveResult(status, solution, time, branches, gamma_one::Int, avg_vars::Float64, solver::String) = SolveResult(status, solution, time, branches, gamma_one, avg_vars, 0, 0, solver)
